<template>
  ...
  >
    ...
    <ListItem><a href="https://twitter.com/antfu7/status/1468233216939245579" target="_blank" rel="noopener noreferrer">Smart & instant watch mode, like HMR for tests!</a></ListItem>
    ...
    <ListItem>Workers multi-threading via <a href="https://github.com/Aslemammad/tinypool" rel="noopener noreferrer" target="_blank">tinypool</a></ListItem>
    ...
    <ListItem><a target="_blank" href="https://www.chaijs.com/" rel="noopener noreferrer">Chai</a> built-in for assertions + <a href="https://jestjs.io/docs/expect" rel="noopener noreferrer">Jest expect</a> compatible APIs</ListItem>
    ...
    <ListItem><a target="_blank" href="https://github.com/jsdom/jsdom" rel="noopener noreferrer">jsdom</a> or <a target="_blank" href="https://github.com/capricorn86/happy-dom" rel="noopener noreferrer">happy-dom</a> for DOM mocking</ListItem>
