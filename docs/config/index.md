...
To preview the coverage report in the output of [HTML reporter](/guide/reporters.html#html-reporter), this option must be set as an subdirectory of the html report (for example `./html/coverage`).
