...
- **Type:** `'node' | 'jsdom' | 'happy-dom' | 'edge-runtime' | 'miniflare'`
- **Default:** `'node'`
...
If you are building for Cloudflare Workers, you can use the [`miniflare`](https://github.com/cloudflare/miniflare) environment
