...
In such situations, Vitest provides default mocks with default returned values for
...
recommended for the user to mock these web APIs for better experience. Read more
in [Mocking](/guide/mocking).
