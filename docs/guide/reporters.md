...
to provide annotations for test failures. This reporter is automatically enabled when the `reporters` setting is unset and `process.env.GITHUB_ACTIONS === 'true'`.
