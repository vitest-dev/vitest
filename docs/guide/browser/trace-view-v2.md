...
<!-- TODO: experimental version, rename md, better cross link, add screenshot -->
...
Selecting a test that has a trace automatically opens the trace viewer in the top panel.
