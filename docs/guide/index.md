...
| `http` | [GitHub](https://github.com/vitest-dev/vitest/tree/main/examples/http) | [Play Online](https://stackblitz.com/fork/github/vitest-dev/vitest/tree/main/examples/http?initialPath=__vitest__/) |
