...
export function JestChaiExpect(): ChaiPlugin {
  return (chai, utils) => {
    ...
    utils.addMethod(
      proto,
      "toEqual",
      function (this: Chai.Assertion, expected: any) {
    ...
    utils.addMethod(
      proto,
      "toMatch",
      function (this: Chai.Assertion, expected: string | RegExp) {
    ...
    utils.addMethod(
      proto,
      "toContain",
      function (this: Chai.Assertion, item: any) {
    ...
    utils.addMethod(
      proto,
      "toContainEqual",
      function (this: Chai.AssertionStatic, expected: any) {
    ...
    utils.addMethod(
      proto,
      "toBeInstanceOf",
      function (this: Chai.Assertion, obj: any) {
    ...
    utils.addMethod(
      ...
      function (this: Chai.Assertion, number: number) {
