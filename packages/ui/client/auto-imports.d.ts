...
declare global {
  ...
  const files: typeof import('./composables/tests-status')['files']
  ...
  const finished: typeof import('./composables/tests-status')['finished']
  ...
  const testStatus: typeof import('./composables/tests-status')['testStatus']
