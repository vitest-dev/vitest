...
export class FakeTimers {
  ...
  useFakeTimers(): void {
    ...
    if (!this._fakingTime) {
      const toFake = Object.keys(this._fakeTimers.timers).filter(name => name !== 'queueMicrotask' && name !== 'performance' && name !== 'hrtime') as Array<keyof FakeTimerWithContext['timers']>
