...
cli
  ...
  .option('--coverage.thresholds.perFile', 'Check thresholds per file. See --coverage.thresholds.lines, --coverage.thresholds.functions, --coverage.thresholds.branches and --coverage.thresholds.statements for the actual thresholds. This option is not available for custom providers (default: false)')
  .option('--coverage.thresholds.autoUpdate', 'Update threshold values: "lines", "functions", "branches" and "statements" to configuration file when current coverage is above the configured thresholds. This option is not available for custom providers (default: false)')
  .option('--coverage.thresholds.lines', 'Threshold for lines. Visit https://github.com/istanbuljs/nyc#coverage-thresholds for more information. This option is not available for custom providers')
  .option('--coverage.thresholds.functions', 'Threshold for functions. Visit https://github.com/istanbuljs/nyc#coverage-thresholds for more information. This option is not available for custom providers')
  .option('--coverage.thresholds.branches', 'Threshold for branches. Visit https://github.com/istanbuljs/nyc#coverage-thresholds for more information. This option is not available for custom providers')
  .option('--coverage.thresholds.statements', 'Threshold for statements. Visit https://github.com/istanbuljs/nyc#coverage-thresholds for more information. This option is not available for custom providers')
  .option('--coverage.thresholds.100', 'Shortcut to set all coverage thresholds to 100. This option is only available for the v8 provider (default: false)')
