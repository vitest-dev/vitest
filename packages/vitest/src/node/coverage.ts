...
import type { BaseCoverageOptions, CoverageModuleLoader, CoverageProvider, CoverageProviderModule, ReportContext, ResolvedCoverageOptions } from './types/coverage'
...
import { resolveCoverageReporters } from './config/resolveConfig'
...
export async function getCoverageProvider(
  ...
  const coverageModule = await resolveCoverageProviderModule(options, loader) as CoverageProviderModule
