 ...
 *
 * Used to keep image data and destination together through.
 */
 ...
 * 3. Determine the outcome based on comparison results and update settings
...
async function determineOutcome(
  ...
  // no reference to compare against — create or skip based on update settings
