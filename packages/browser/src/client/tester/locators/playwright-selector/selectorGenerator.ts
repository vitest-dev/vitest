...
function buildNoTextCandidates(injectedScript: PlaywrightSelector, element: Element, options: InternalOptions): SelectorToken[] {
...
function buildTextCandidates(injectedScript: PlaywrightSelector, element: Element, isTargetNode: boolean): SelectorToken[][] {
...
function chooseFirstSelector(injectedScript: PlaywrightSelector, scope: Element | Document, targetElement: Element, selectors: SelectorToken[][], allowNthMatch: boolean): SelectorToken[] | null {
