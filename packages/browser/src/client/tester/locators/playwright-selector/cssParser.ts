...
export interface CSSFunction { name: string; args: CSSFunctionArgument[] }
export interface CSSSimpleSelector { css?: string; functions: CSSFunction[] }
export interface CSSComplexSelector { simples: { selector: CSSSimpleSelector; combinator: ClauseCombinator }[] }
