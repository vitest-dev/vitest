...
export interface NestedSelectorBody { parsed: ParsedSelector; distance?: number }
...
export interface ParsedSelectorPart {
  name: string
...
interface ParsedSelectorStrings {
...
export interface AttributeSelectorPart {
  name: string
  jsonPath: string[]
