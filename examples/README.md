...
| `gatsby` | [GitHub](https://github.com/vitest-dev/vitest/tree/main/examples/gatsby) | [Play Online](https://stackblitz.com/fork/github/vitest-dev/vitest/tree/main/examples/gatsby?initialPath=__vitest__) |
