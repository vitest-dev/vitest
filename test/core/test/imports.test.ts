...
test('dynamic import throws an error', async () => {
  ...
  await expect(imported).rejects.toThrowError(/Cannot find package '\.\/some-unknown-path' imported/)
  // @ts-expect-error path does not exist
  await expect(() => import('./some-unknown-path')).rejects.toThrowError(/Cannot find package/)
})
