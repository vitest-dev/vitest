...
test('nested test should throw error', () => {
  ...
  }).toThrowErrorMatchingInlineSnapshot(`[Error: Calling the "test" or "it" function inside another "test" or "it" function is not allowed. Please put it inside "describe" so it can be properly collected.]`)
