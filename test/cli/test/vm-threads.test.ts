...
// The module-sync condition and the _resolveFilename conditions option were
// both added in Node 22.12 when require(esm) was unflagged. The bug only
// exists on 22.12+ and so does the fix.
