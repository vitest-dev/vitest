...
describe('default reporter', async () => {
  ...
  test('test.each/for title truncate', async () => {
    ...
    expect(result.errorTree()).toMatchInlineSnapshot(`
      {
        "fixtures/reporters/test-for-title-truncate.test.ts": {
          "$ (array: 3) [ 'one', 'two', … ]": "passed",
          "$ (array: 4) [ 'one', 'two', … ]": "passed",
          "$ (array: 5) [ 'one', 'two', … ]": "passed",
          "$ (object: 3) { one: 1, … }": "passed",
          "$ (object: 4) { one: 1, … }": "passed",
          "$ (object: 5) { one: 1, … }": "passed",
